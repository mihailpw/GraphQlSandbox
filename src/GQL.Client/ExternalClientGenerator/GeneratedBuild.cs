...
namespace GQL.Client.ExternalClientGenerator
{
...
internal static class GraphQlQueryHelper
{
    ...
    public static string BuildInputObject(IGraphQlInputObject inputObject, Formatting formatting, int level,
        byte indentationSize)
    {
        var builder = new StringBuilder();
        builder.Append("{");
...
{
    private readonly Dictionary<string, GraphQlFieldCriteria> _fieldCriteria =
        new Dictionary<string, GraphQlFieldCriteria>();
    ...
    protected void IncludeObjectField(string fieldName, GraphQlQueryBuilder objectFieldQueryBuilder,
    ...
    private class GraphQlObjectFieldCriteria : GraphQlFieldCriteria
    {
        ...
        public GraphQlObjectFieldCriteria(string fieldName, GraphQlQueryBuilder objectQueryBuilder,
            IDictionary<string, object> args) : base(fieldName, args)
        {
...
public abstract class GraphQlQueryBuilder<TQueryBuilder> : GraphQlQueryBuilder
    where TQueryBuilder : GraphQlQueryBuilder<TQueryBuilder>
{
    ...
    protected TQueryBuilder WithObjectField(string fieldName, GraphQlQueryBuilder queryBuilder,
...
public class UsersQueryQueryBuilder : GraphQlQueryBuilder<UsersQueryQueryBuilder>
{
    private static readonly FieldMetadata[] AllFieldMetadata =
        new[]
        {
            new FieldMetadata {Name = "user", IsComplex = true, QueryBuilderType = typeof(UserInterfaceQueryBuilder)},
            new FieldMetadata {Name = "users", IsComplex = true, QueryBuilderType = typeof(UserInterfaceQueryBuilder)}
        };

    protected override IList<FieldMetadata> AllFields
    {
        get { return AllFieldMetadata; }
    }
...
public class UserInterfaceQueryBuilder : GraphQlQueryBuilder<UserInterfaceQueryBuilder>
{
    private static readonly FieldMetadata[] AllFieldMetadata =
        new[]
        {
            ...
            new FieldMetadata
                {Name = "friends", IsComplex = true, QueryBuilderType = typeof(UserInterfaceQueryBuilder)},
    ...
    public UserInterfaceQueryBuilder WithEmail()
    {
        return WithScalarField("email");
    }

    public UserInterfaceQueryBuilder WithFriends(UserInterfaceQueryBuilder userInterfaceQueryBuilder,
        string email = null)
    {
        var args = new Dictionary<string, object>();
        if (email != null)
    ...
    public UserInterfaceQueryBuilder WithId()
    {
        return WithScalarField("id");
    }

    public UserInterfaceQueryBuilder WithName()
    {
        return WithScalarField("name");
    }

    public UserInterfaceQueryBuilder WithRoles()
    {
...
public class UsersMutationQueryBuilder : GraphQlQueryBuilder<UsersMutationQueryBuilder>
{
    private static readonly FieldMetadata[] AllFieldMetadata =
        ...
        {
            new FieldMetadata
                {Name = "createUser", IsComplex = true, QueryBuilderType = typeof(UserInterfaceQueryBuilder)},
            new FieldMetadata
                {Name = "createUsers", IsComplex = true, QueryBuilderType = typeof(UserInterfaceQueryBuilder)}
        };
    ...
    public UsersMutationQueryBuilder WithCreateUsers(UserInterfaceQueryBuilder userInterfaceQueryBuilder,
        IEnumerable<UserInput> users)
    {
        var args = new Dictionary<string, object>();
...
public class UsersSubscriptionQueryBuilder : GraphQlQueryBuilder<UsersSubscriptionQueryBuilder>
{
    private static readonly FieldMetadata[] AllFieldMetadata =
        new[]
        {
            new FieldMetadata {Name = "addUser", IsComplex = true, QueryBuilderType = typeof(UserInterfaceQueryBuilder)}
        };
...
{
    public UserInterface CreateUser { get; set; }
    public UserInterface CreateUsers { get; set; }
}

public class UsersSubscription
{
    public UserInterface AddUser { get; set; }
}
